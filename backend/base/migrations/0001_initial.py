# Generated by Django 3.2 on 2022-01-04 13:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=3, max_digits=10, null=True)),
                ('lon', models.DecimalField(blank=True, decimal_places=3, max_digits=10, null=True)),
                ('created_at', models.DateField(auto_now_add=True, null=True)),
                ('due_date', models.DateField(blank=True, null=True)),
                ('status', models.CharField(blank=True, choices=[('Active', 'Active'), ('Complete', 'Complete'), ('On Hold', 'On Hold'), ('Past Due', 'Past Due')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='base.project')),
            ],
        ),
    ]
