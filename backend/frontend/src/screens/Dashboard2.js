          ...
          <Col lg="3" sm="6">
            <Card className="card-stats">
                ...
                <Row>
                  <Col xs="5">
                    <div className="icon-warning">
                      <FaChartPie size={48} className="text-warning" />
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Number of Projects</p>
                      <Card.Title as="h4">{projects.length}</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
              <Card.Footer className="mb-3">
                ...
                <div className="stats">
                  <FaRedo />
                  <span className="m-2">Update now</span>
                </div> */}
              </Card.Footer>
            </Card>
          </Col>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  <Col xs="5">
                    <div className="icon-warning">
                      <FaLightbulb size={48} className="text-success" />
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category"># of Active Projects</p>
                      <Card.Title as="h4">
                        {
              ...
              <Card.Footer>
                ...
                <div className="stats">
                  <FaCalendarAlt />
                  <span className="p-2">Update now</span>
                </div>
              </Card.Footer>
            </Card>
          </Col>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category"># of Late Projects</p>
                      <Card.Title as="h4">
                        {' '}
                        {
                          projects.filter((item) => item.status === 'Past Due')
                            .length
                        }
                      </Card.Title>
                    </div>
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  ...
                  <Col xs="9">
                    <div className="numbers">
                      <p className="card-category"># of Completed Projects</p>
                      <Card.Title as="h4">
                        {
